    ...
    <div>
      ...
      <div className="container mx-auto p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
          <>
            {data.map((card: any) => (
              <Image key={card.attributes.image.data.id} className="w-full rounded-xl shadow-md" src={"http://localhost:1337" + card.attributes.image.data.attributes.url} width={500}
                height={500}
