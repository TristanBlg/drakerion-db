          ...
          {successMessage ? (
            ...
            <>
              <input
                ...
                value={email}
                className={"w-3/5 p-3 rounded-l-lg sm:w-2/3 text-slate-700"}
              />
              <button
                type="button"
                className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 dark:bg-violet-400 dark:text-slate-900"
